...
<br/>
  ...
  <br>
  <table width="96%" height="577" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#bdc7d3" class="text_lb">
    <tr>
      ...
      <td width="300" bgcolor="#FFFFFF"><input name="textarea4" type="text" id="textarea4" value="" size="30" class="pi"></td>
    ...
    <tr>
      <td height="23" align="right" bgcolor="#FFFFFF">身份证号码：</td>
      <td colspan="4" bgcolor="#FFFFFF"><input name="textarea11" type="text" id="textarea11" value="" size="30" class="pi"></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td colspan="2" bgcolor="#FFFFFF"><input name="textarea15" type="text" id="textarea15" value="" size="30" class="pi"></td>
    </tr>
    <tr>
