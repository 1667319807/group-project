...
<select name="select" id="select" class="input">
  ...
  <option value="3">在别处成交</option>
  <option value="4">已取消</option>
</select>
        <input type="button" name="searchbtn" value="查询" class="button_new">
        <input type="button" name="searchbtn2" value="新增" class="button_new"onClick="javascript:location.href='ddgl_xz.htm'" >
    ...
    <tr>
      <td><input type="hidden" name="orderType" value="asc">
          ...
          <table width="90%" style="font-size:12px;" border="0" cellspacing="3" cellpadding="2">
            <tr>
              <td nowrap width="45%" align="center"> 当前第一页，共10条记录，分1页显示 </td>
