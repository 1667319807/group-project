    ...
    <td background="../image/red_BODY_bg.gif"><table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td><table height="23"  border="0" cellpadding="0" cellspacing="0">
              <tr align="center">
                <td width="82" class="Column_blue">修改组织机构</td>
              </tr>
          </table></td>
        </tr>
    </table></td>
    ...
    <td><table width="100%" height="10"  border="0" cellpadding="0" cellspacing="0">
	  ...
	  <table width="96%" style="TABLE-LAYOUT: fixed;" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#Cbcbcb">
	   <!-- <tr class="td2">
		...
		<tr class="td2">
          <td width="20%" align="right" nowrap>机构名称：</td>
...
<input name="receiver" type="button" class="button_new" value="选择人员" elname="vo.principalUser,pusername" onClick="selectMailMan()">
		...
		<tr class="td2">
          <td width="20%" align="right" nowrap>内容简介：</td>
          <td width="80%" colspan="3" style="LEFT: 0px; WIDTH: 100%; WORD-WRAP: break-word;">
				<textarea name="vo.description" cols="70" rows="8"  maxlength="100" onFocus="javascript:setMaxLen()">请输入分组描述</textarea>
		  </td>
        </tr> 
        
        <tr class="td2">
          <td width="20%" align="right" nowrap>排列序号：</td>
          <td width="80%" colspan="3">
				<input type="text" name="vo.sortNo" ValidateType="notempty,int" Msg="排列序号不能为空!;排列序号必须为数字!" maxlength="125" value="0" class="input"><font color=red>*</font>
		  </td>
        </tr>
