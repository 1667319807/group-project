    ...
    <td background="../image/red_BODY_bg.gif"><table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td><table height="23"  border="0" cellpadding="0" cellspacing="0">
              <tr align="center">
                <td width="82" class="Column_blue">�޸���֯����</td>
              </tr>
          </table></td>
        </tr>
    </table></td>
	   ...
	   <!-- <tr class="td2">
		...
		<tr class="td2">
          ...
          <td width="80%" colspan="3">
				<input type="text" name="vo.name" ValidateType="notempty" Msg="�������Ʋ���Ϊ��!" maxlength="125" value="ϵͳ�û�" class="input"><font color=red>*</font>
		  </td>
        </tr>
...
<input name="receiver" type="button" class="button_new" value="ѡ����Ա" elname="vo.principalUser,pusername" onClick="selectMailMan()">
		...
		<tr class="td2">
          <td width="20%" align="right" nowrap>���ݼ�飺</td>
          <td width="80%" colspan="3" style="LEFT: 0px; WIDTH: 100%; WORD-WRAP: break-word;">
				<textarea name="vo.description" cols="70" rows="8"  maxlength="100" onFocus="javascript:setMaxLen()">�������������</textarea>
		  </td>
        </tr> 
        
        <tr class="td2">
          <td width="20%" align="right" nowrap>������ţ�</td>
          <td width="80%" colspan="3">
				<input type="text" name="vo.sortNo" ValidateType="notempty,int" Msg="������Ų���Ϊ��!;������ű���Ϊ����!" maxlength="125" value="0" class="input"><font color=red>*</font>
		  </td>
        </tr>
