    ...
    <td background="../image/red_BODY_bg.gif"><table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td><table height="23"  border="0" cellpadding="0" cellspacing="0">
              <tr align="center">
                <td width="96" class="Column_blue">修改用户</td>
              </tr>
          </table></td>
        </tr>
    </table></td>
  ...
  <tr>
    ...
    <td><table width="100%" height="10"  border="0" cellpadding="0" cellspacing="0">
	  ...
	  <!--  <tr class="td2">
          ...
          <td width="30%" ><input type="text" name="vo.trueName" maxlength="15" value="张广宁" class="input"> 
	 ...
	 <tr class="td2">
         ...
         <tr class="td2">
          ...
          <td width="30%" ><input type="text" name="vo.appellation" maxlength="15" value="张市长" class="input"></td>
      ...
      <table width="96%" height="30"  border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td align="center"><input name="B3" type="submit" class="button_new" onClick="return OK();" value="保存">
            <input name="B" type="button" class="button_new" onClick="window.location.href='yhgl.htm'" value="后退"></td>
        </tr>
      </table></td>
