              ...
              <td background="../image/red_BODY_bg.gif"><table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td><table height="23"  border="0" cellpadding="0" cellspacing="0">
                        <tr align="center">
                          <td width="82" class="Column_blue">详细</td>
                        </tr>
                    </table></td>
                  </tr>
              </table></td>
          ...
          <table width="94%"  border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td><table width="100%" height="10"  border="0" cellpadding="0" cellspacing="0">
                  ...
                  <table width="96%" height="30"  border="0" align="center" cellpadding="0" cellspacing="0" class="MENU_line">
                    <tr>
                      <td width="67%" align="right" class="text" nowrap>&nbsp;
                       ...
                       <input type="submit" name="searchbtn2" value="查询" class="button_new">
                ...
                <table width="92%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CBCBCB">
                  <tr align="center" class="tdtitle">
                    <td nowrap align="center" width="20"><input type="checkbox" onClick="checkAll(this,'fid')"></td>
                    <td width="110" align="center" nowrap id=".dataTypeF2" onClick="orderBy(this)"><div orderBy="true">
                      显示值</td>
                    <td width="101" align="center" nowrap id=".remarkF2" onClick="orderBy(this)"><div orderBy="true">实际值</div></td>
                    <td width="229" align="center" nowrap id=".remarkF2" onClick="orderBy(this)">公用标志</td>
                    <td width="119" align="center" nowrap id=".remarkF2" onClick="orderBy(this)">创建人</td>
                    <td width="94" align="center" nowrap id=".remarkF2" onClick="orderBy(this)">创建时间</td>
                    <td width="110" align="center" nowrap id=".remarkF2" onClick="orderBy(this)">排序号</td>
                    <td nowrap align="center" width="77">操作</td>
                  </tr>
                </table>
