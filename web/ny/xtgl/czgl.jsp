    ...
    <script>
        function amount() {
            ...
            for (var i = 0; i < counts.length; i++) {
                b+=parseInt(counts[i].value) ;
            }
            document.getElementById("div").innerText=b;
            var a=0;
            var moneys = document.getElementsByClassName("money");
            for (var i = 0; i < moneys.length; i++) {
                a+=parseInt(moneys[i].value) ;
            }
            document.getElementById("div1").innerText=a;
            var c=0;
            var balances = document.getElementsByClassName("balance");
            for (var i = 0; i < balances.length; i++) {
                c+=parseInt(balances[i].value) ;
            }
...
<table width="96%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#bdc7d3">
    <tr align="center" class="tdtitle">
        ...
        <td width="10%" align="center" nowrap id=".register">
            <div align="center" orderBy="true"><strong>操作人</strong></div>
        </td>
    ...
    <c:forEach var="list" items="${requestScope.recharges}">
        <tr align="center" class="td2" onmouseover="javascript:changeBgColorOnMouseOver(this);"
            ...
            <td align="center" nowrap>${list.card.card_count} <input type="hidden" class="count"
                                                                     value="${list.card.card_count}"></td>
            <td align="center" nowrap>${list.card.card_standard}</td>
            <td height="14" align="center" nowrap>${list.card.card_money} <input type="hidden" class="money"
                                                                                 value="${list.card.card_money}"></td>
            <td align="center" nowrap>${list.card.card_balance} <input type="hidden" class="balance"
                                                                       value="${list.card.card_balance}"></td>
            <td align="center" nowrap>${list.operator_id}</td>
            <td align="center" nowrap>${list.remark}</td>
            <td align="center" nowrap><a
                    href="/ny/xtgl/czgl_xz.jsp?recharge_id=${list.recharge_id}&company_account=${list.company.company_account}">充值</a>
            </td>
        </tr>
    </c:forEach>
    <tr align="center" class="td1" onmouseover="javascript:changeBgColorOnMouseOver(this);"
        ...
        <td colspan="3" align="right" nowrap><strong id="total">合计总额:</strong></td>
        <td height="14" align="left" nowrap>
            <div align="center" class="STYLE1" id="div"></div>
        </td>
        <td height="14" align="left" nowrap>
            <div align="center"><span class="STYLE1"></span></div>
        </td>
        <td height="14" align="left" nowrap>
            <div align="center" class="STYLE1" id="div1"></div>
        </td>
        <td height="14" align="left" nowrap>
            <div align="center" class="STYLE1" id="div2"></div>
        </td>
    ...
    <tr>
        <td><input type="hidden" name="orderType" value="asc">
            ...
            <table width="90%" style="font-size:12px;" border="0" cellspacing="3" cellpadding="2">
                <tr>
                    <td nowrap width="45%" align="center"> 当前第${page.pageNum}页 共${page.totalPage}记录
                        分${page.pageSize}页显示
                    </td>
